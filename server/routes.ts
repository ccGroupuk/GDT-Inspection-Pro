      ...
      if (contact.email) {
        (async () => {
          try {
            ...
            console.log(`[auto-notify] Portal message notification emailed to ${contact.email}`);
          } catch (emailError) {
            console.error("[auto-notify] Failed to send portal message notification:", emailError);
          }
        })();
      }
